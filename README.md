...
[![pre-commit](https://github.com/lablabs/terraform-aws-eks-ingress-nginx/workflows/pre-commit.yml/badge.svg)](https://github.com/lablabs/terraform-aws-eks-ingress-nginx/actions/workflows/pre-commit.yml)

## Description

A terraform module to deploy an Ingress Nginx Controller on Amazon EKS cluster.
...
| <a name="input_helm_chart_version"></a> [helm\_chart\_version](#input\_helm\_chart\_version) | Version of the Helm chart | `string` | `"4.1.4"` | no |
